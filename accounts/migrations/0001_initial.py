# Generated by Django 5.1.5 on 2025-09-05 18:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, storage=accounts.storage.SupabaseStorage(), upload_to='')),
                ('features', models.JSONField(default=list, validators=[accounts.models.validate_json_list])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('edited_image', models.ImageField(help_text='The edited image file', storage=accounts.storage.SupabaseStorage(), upload_to='')),
